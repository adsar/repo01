...
# -----------------------------------------------------------------------------------------------
def sim_matrix():
    # collect text into 30 docuemtns
    text, c_names = preprocess_text()

    # create bow representations: 30 docs x 10000 features
    ...
    #for i, doc_a in enumerate(doc_topics_noIdf_100 ):
    ...
    #doc_topics_idf_30 = reduce_dimensionality_with_lda(X_idf, 30)
    print('LDA 100-topic output:')
    ...
    #sim_matrix_idf_100_cosine_top5Topics = compute_similarity_matrix(doc_topics_idf_100, "cosine", 0.2, 'cuisine_sim_matrix_idf_lda_cosine_top5Topics')
    #sim_matrix_idf_30_cosine_top5Topics = compute_similarity_matrix(doc_topics_idf_30, "cosine", 0, 'cuisine_sim_matrix_idf_lda_30_cosine_top5Topics')

    # clustering of Similarity Matrix
    clusters_sim_matrix_idf_100_cosine_allTopics_kmeans_8 = cluster_matrix(sim_matrix_idf_100_cosine_allTopics, "MiniBatchKMeans", 8)
    clusters_sim_matrix_idf_100_cosine_allTopics_kmeans_12 = cluster_matrix(sim_matrix_idf_100_cosine_allTopics, "MiniBatchKMeans", 12)
    clusters_sim_matrix_idf_100_cosine_allTopics_kmeans_16 = cluster_matrix(sim_matrix_idf_100_cosine_allTopics, "MiniBatchKMeans", 16)
    ...
    save_cluster_labels(clusters_sim_matrix_idf_100_cosine_allTopics_kmeans_12, "cuisine_sim_matrix_idf_lda_cosine_allTopics_kmeans_12.txt")
    save_cluster_labels(clusters_sim_matrix_idf_100_cosine_allTopics_kmeans_16, "cuisine_sim_matrix_idf_lda_cosine_allTopics_kmeans_16.txt")

    clusters_sim_matrix_idf_100_cosine_allTopics_dbscan_8 = cluster_matrix(sim_matrix_idf_100_cosine_allTopics, "DBSCAN", 8)
    clusters_sim_matrix_idf_100_cosine_allTopics_dbscan_12 = cluster_matrix(sim_matrix_idf_100_cosine_allTopics, "DBSCAN", 12)
    clusters_sim_matrix_idf_100_cosine_allTopics_dbscan_16 = cluster_matrix(sim_matrix_idf_100_cosine_allTopics, "DBSCAN", 16)

    save_cluster_labels(clusters_sim_matrix_idf_100_cosine_allTopics_dbscan_8, "cuisine_sim_matrix_idf_lda_cosine_allTopics_dbscan_8.txt")
    save_cluster_labels(clusters_sim_matrix_idf_100_cosine_allTopics_dbscan_12, "cuisine_sim_matrix_idf_lda_cosine_allTopics_dbscan_12.txt")
    save_cluster_labels(clusters_sim_matrix_idf_100_cosine_allTopics_dbscan_16, "cuisine_sim_matrix_idf_lda_cosine_allTopics_dbscan_16.txt")
...
def cluster_matrix(adj_matrix, method, K):
    ...
    clustering_algorithms = [two_means, dbscan]
